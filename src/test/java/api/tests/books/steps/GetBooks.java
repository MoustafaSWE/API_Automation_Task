...
import static api.tests.books.resources.GetBooks.constructExpectedResponseInterface;
import static io.restassured.RestAssured.given;

public class GetBooks {
    public void getBooks(ExtentTest test) {

        //API Full URL
        String getBooksUrl = EnvironmentConfig.testedEnvironmentBaseUrl.concat(Endpoint.booksEndpoint);
        ...
        //API Call
        JSONObject networkObjects = ApiCall.execute(ApiCall.ApiVerb.GET, request, getBooksUrl);
