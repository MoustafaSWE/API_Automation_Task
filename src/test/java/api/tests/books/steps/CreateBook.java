...
public class CreateBook {
    ...
    public void createBook(ExtentTest test) {

        //API Full URL
        String createBookUrl = EnvironmentConfig.testedEnvironmentBaseUrl.concat(Endpoint.booksEndpoint);
        ...
        //API Call
        JSONObject networkObjects = ApiCall.execute(ApiCall.ApiVerb.POST, request, createBookUrl);
