...
public class CreateAuthor {
    ...
    public void createAuthor(ExtentTest test) {

        //API Full URL
        String createAuthorUrl = EnvironmentConfig.testedEnvironmentBaseUrl.concat(Endpoint.authorEndpoint);
        ...
        //API Call
        JSONObject networkObjects = ApiCall.execute(ApiCall.ApiVerb.POST, request, createAuthorUrl);
